 ...
 *             "devtools.supported" or "info.get" messages,
 *             or call the browser.tabs.getCurrent(),
...
port.on("app.get", (message, sender) =>
{
  ...
  {
    let bidiDir = browser.i18n.getMessage("@@bidi_dir");
    return {locale: info.locale, bidiDir};
  }
